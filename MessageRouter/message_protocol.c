...
void extract_request_id(uint64_t message, uint64_t* id) {
    *id = message & REQUEST_ID_MASK;
}

void insert_request_id(uint64_t request_id, uint64_t encoded) {
    encoded = encoded & REQUEST_ID_MASK;
